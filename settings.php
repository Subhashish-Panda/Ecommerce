...
<html>
    <head>
        ...
        <style>
            ...
            .style_chngpswd{
            background: url(images/ecom_change.jpg) no-repeat center;   
            }
            footer{
            padding: 10px 0;
    ...
    <body>
        ...
        <div class="container-fluid style_chngpswd" style="min-height: 650px;">
            <div class="row row_style">
                <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                    <div class="panel style_form">
                        <div class="panel-heading" style="text-align:center;background-color:rgba(0,0,0,0);color:whitesmoke;">
